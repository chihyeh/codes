...
void jetSubstructure(string inputDir, float radius=0.4, int mode=0){
  ...
  const int nhistos=14;//ntemp_histos;

  std::cout << "Total number of histograms is " << nhistos << std::endl;
  const float xmax[nhistos]={400,250,400,400,400,1,0.3,20,1,1,0.3,20,1,1};
  ...
  string inputFile = inputDir + "/radius" + Form("%0.1f",radius)+ "_response_tGEN_nonu2.root";
